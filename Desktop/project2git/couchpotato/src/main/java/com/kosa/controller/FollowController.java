...
//	나를 팔로잉 한 인간 리스트 
    ...
    @ResponseBody
    public ResponseEntity<Map<String, Object>> getFollowList(@RequestParam int user_number) throws Exception {
 ...
 // 팔로우 
    ...
    public ResponseEntity<String> follow(@RequestBody Map<String, Integer> requestBody) throws Exception {
        ...
        System.out.println("follow에 있는 정보"+"user_number : "+user_number+", follower_id : "+follower_id+", following_id : "+following_id);
    ...
    public ResponseEntity<String> unfollow(@RequestBody Map<String, Integer> requestBody) throws Exception {
        ...
        System.out.println("unfollow에 있는 정보 user_number : " + user_number + ", follower_id : " + follower_id + ", following_id : " + following_id);
        ...
        System.out.println("unfollow 요청 수신됨 - user_number: " + user_number + ", follower_id: " + follower_id + ", following_id: " + following_id);
